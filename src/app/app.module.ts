...
import { StoplightChangeModalComponent } from './myComponents/stoplight-change-modal/stoplight-change-modal.component';
...
@NgModule({
  declarations: [AppComponent, FullLayoutComponent, ContentLayoutComponent, StoplightChangeModalComponent],
  imports: [
